...
Usage:
    python export_firered_trt.py \
        --model-dir data/models/firered_asr2/FireRedASR2-AED \
        --output-dir data/models/firered_asr2/FireRedASR2-AED-TRT

This creates:
    data/models/firered_asr2/FireRedASR2-AED-TRT/
...
# Add project scripts dir and FireRed source to path
_PROJECT_DIR = os.path.dirname(os.path.abspath(__file__))
_PARENT_DIR = os.path.dirname(_PROJECT_DIR)
_COMICUT = os.path.dirname(os.path.dirname(_PROJECT_DIR))  # ComicCut root
if _PROJECT_DIR not in sys.path:
    sys.path.insert(0, _PROJECT_DIR)

# Load config to get FireRed path
from config import FIRERED_ASR2S_PATH
_FIRERED_PATH = FIRERED_ASR2S_PATH
